...
/* Structure to represent a IOT_ resource */
...
/* Function that creates a new IOT_ resource by calling the
...
/* This method changes the IOT_ power using an independent thread
